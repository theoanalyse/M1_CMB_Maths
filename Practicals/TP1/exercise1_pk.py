...
def main():
    # input given
    ts = np.array([0, 0.5, 1, 1.5, 2, 3, 5, 7.5, 10, 15, 20, 24])
    ys = np.array([23.8, 22.1, 20.5, 19, 17.6, 15.2, 11.3, 7.82, 5.29, 2.57, 1.22, 0.68])
    lys = np.log(ys)
    ...
    (a, b, rho, p, stderr) = ss.linregress(ts, lys)
    ...
    # gradient method
    sol, res1 = gradient_method(A, lys, t=1e-4) # 6072 iterations
    ...
    sol2, res2 = gradient_method(A, lys, t=best_t) # converges in 1011 steps
